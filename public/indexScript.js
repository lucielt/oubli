...
if (url == '/projet.html') {
    ...
    $('.close').on('click', function()
    {
            ...
            $('#capture-button a').disable(false);
    ...
    $('#message-form form').on('submit', function(e)
    {
      ...
      console.log("je suis rentré dans /cartes");
      $(document).ready(function () {
          size_li = $(".images li").size();
          console.log("list Size "+size_li);
          x=6;
         // $('.images li:lt('+x+')').show();
         $('.images li:lt('+x+')').addClass('changed');
          console.log("x "+x);
